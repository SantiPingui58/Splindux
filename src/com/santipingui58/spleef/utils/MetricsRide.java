...
public class MetricsRide
{
  ...
  public MetricsRide(Plugin plugin) throws IOException {
    if (plugin == null) {
  ...
  public boolean start()
  {
    synchronized (this.optOutLock)
    {
      ...
      this.task = this.plugin.getServer().getScheduler().runTaskTimerAsynchronously(this.plugin, new Runnable()
      {
        ...
        {
          try {
            synchronized (MetricsRide.this.optOutLock)
            {
              if ((MetricsRide.this.isOptOut()) && (MetricsRide.this.task != null)) {
            	  MetricsRide.this.task.cancel();
            	  MetricsRide.this.task = null;
              }

            }

            MetricsRide.this.postPlugin(!this.firstPost);

            this.firstPost = false;
          } catch (IOException e) {
            if (MetricsRide.this.debug)
