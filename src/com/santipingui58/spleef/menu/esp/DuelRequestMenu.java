...
public class DuelRequestMenu extends MenuBuilder {
	...
	public DuelRequestMenu(Player p) {
		super("§a§lDuel " + DuelCommand.temprequest.get(p).getName(), 2);
		
		if (page.get(p) == 1) {

		s(0, new ItemBuilder(Material.DIAMOND_SPADE).setTitle("§aSnow Spleef - Random Map").
				build());
		s(1, new ItemBuilder(Material.DIAMOND_SWORD).setTitle("§aBuild Spleef PvP - Random Map").
				build());
		s(9, new ItemBuilder(Material.DIAMOND_SPADE).setTitle("§aSnow Spleef - Select Map").
				build());
		s(10, new ItemBuilder(Material.DIAMOND_SWORD).setTitle("§aBuild Spleef PvP - Select Map").
				build());
