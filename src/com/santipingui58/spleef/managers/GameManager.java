...
public class GameManager {
    ...
    public void addSpleefFFAQueue (Player p) {
    	...
    	for (final Game g : this.arenas) {
    			if (g.getType().equalsIgnoreCase("ffaspleef")) {
    				...
    				if (GameManager.getManager().isStarted(g)) {
    					if (DataManager.getLang(p).equalsIgnoreCase("ESP")) {
    		    			p.sendMessage("§3"+getGamePrefix(p)+" §6Añadido a la cola para §aFFASpleef");
    					...
    					if (g.getQueue().size() == 3) {
    						for (Player pa : g.getQueue()) {
    							if (DataManager.getLang(pa).equalsIgnoreCase("ESP")) {
    	    		    			pa.sendMessage("§3"+getGamePrefix(p)+" §6La partida comenzará en 5 segundos.");
    	    		    		} else if (DataManager.getLang(pa).equalsIgnoreCase("ENG")) { 
 ...
 public void addBowSpleefUnrankedQueue(Player p, String id) {	
    	...
    	if (id == null) { 	
    		...
    		if (g.getQueue().size() >= 1) {
    			...
    			if (DataManager.getLang(p).equalsIgnoreCase("ESP")) {
    			p.sendMessage("§3"+getGamePrefix(p)+" §6Añadido a la cola §bUnranked §6para §aBuild Spleef PvP 1vs1§6, en el mapa §b" + g.getId());
    			} else if (DataManager.getLang(p).equalsIgnoreCase("ENG")) {
				...
				ga = av.get(no);
    					if (DataManager.getLang(p).equalsIgnoreCase("ESP")) {
    		    			p.sendMessage("§3"+getGamePrefix(p)+" §6Añadido a la cola §bUnranked §6para §aBuild Spleef PvP 1vs1§6, en el mapa §b" + ga.getId());
    		    			} else if (DataManager.getLang(p).equalsIgnoreCase("ENG")) {
 ...
 public void addBSPUnrankedQueue(Player p, String id) {	
    ...
    public void addSpleef2v2Queue (Player p, String id) {
    		...
    		if (g.getType().equalsIgnoreCase("spleef2v2")) {
    			...
    			if (!this.arenasingame.contains(g)) {
    				if (g.getQueue().size() >= 1) {
    					...
    					if (!GameManager.getManager().rankedgames.contains(g)) {
    		    			if (DataManager.getLang(p).equalsIgnoreCase("ESP")) {
    		    			p.sendMessage("§3"+getGamePrefix(p)+" §6Añadido a la cola §bUnranked §6para §aSnow Spleef 2vs2§6, en el mapa §b" + g.getId());
    		    			} else if (DataManager.getLang(p).equalsIgnoreCase("ENG")) {
		...
		ga = av.get(no);
				if (DataManager.getLang(p).equalsIgnoreCase("ESP")) {
	    			p.sendMessage("§3"+getGamePrefix(p)+" §6Añadido a la cola §bUnranked §6para §aSnow Spleef 2vs2§6, en el mapa §b" + ga.getId());
	    			} else if (DataManager.getLang(p).equalsIgnoreCase("ENG")) {
    			...
    			for (Game g : this.arenas) {
    				...
    				if (Main.containsIgnoreCase(g.getId(), id)) {
    					...
    					for (Game ga : av) {
    						...
    						if (DataManager.getLang(p).equalsIgnoreCase("ESP")) {
    			    			p.sendMessage("§3"+getGamePrefix(p)+" §6Añadido a la cola §bUnranked §6para §aSnow Spleef 1vs1§6, en el mapa §b" + ga.getId());
    			    			} else if (DataManager.getLang(p).equalsIgnoreCase("ENG")) {
    ...
    public void addUnrankedQueue(Player p, String id) {	
    	...
    	if (id == null) { 	
    		...
    		if (g.getQueue().size() >= 1) {
    			if (!GameManager.getManager().rankedgames.contains(g)) {
    			if (DataManager.getLang(p).equalsIgnoreCase("ESP")) {
    			p.sendMessage("§3"+getGamePrefix(p)+" §6Añadido a la cola §bUnranked §6para §aSnow Spleef 1vs1§6, en el mapa §b" + g.getId());
    			} else if (DataManager.getLang(p).equalsIgnoreCase("ENG")) {
    ...
    public void addRankedQueue(Player p, String id) {	
    	...
    	if (id == null) { 	
    		...
    		if (g.getQueue().size() >= 1) {
    			if (GameManager.getManager().rankedgames.contains(g)) {
    				if (DataManager.getLang(p).equalsIgnoreCase("ESP")) {
    	    			p.sendMessage("§3"+getGamePrefix(p)+" §6Añadido a la cola §bRanked §6para §aSnow Spleef 1vs1§6, en el mapa §b" + g.getId());
    	    			} else if (DataManager.getLang(p).equalsIgnoreCase("ENG")) {
    			...
    			for (Game ga : av) {
    				ga = av.get(no);
    					if (DataManager.getLang(p).equalsIgnoreCase("ESP")) {
        	    			p.sendMessage("§3"+getGamePrefix(p)+" §6Añadido a la cola §bRanked §6para §aSnow Spleef 1vs1§6, en el mapa §b" + ga.getId());
        	    			} else if (DataManager.getLang(p).equalsIgnoreCase("ENG")) {
